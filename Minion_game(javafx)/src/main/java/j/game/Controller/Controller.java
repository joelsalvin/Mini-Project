...
import j.game.Model.GridModel;
import j.game.Model.PacMan;
import j.game.View.GameView;
import j.game.View.Grid;
import j.game.View.StartPage;
...
public class Controller implements GhostMovedListener {
    ...
    public void launch() {
        ...
        URL path = getClass().getResource("/images/minion.png");
        System.out.println(path.toExternalForm());
//        try {
//            FileInputStream inputFile = new FileInputStream(path.getFile());
...
//      path = "/images/happy.png";
        ...
        String iconPath = getClass().getResource("/images/minion.png").toExternalForm();
